...
export async function resolve(specifier, context, next) {
  if (['react-native','expo-audio','expo-file-system'].includes(specifier)) return {url:mocks,shortCircuit:true};
  if (specifier === '../recording-lifecycle') return next('../recording-lifecycle.ts',context);
